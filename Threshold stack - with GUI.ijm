...
local_thresholds = newArray("Bernsen", "Contrast", "Mean", "Median", "MidGrey", "Niblack", "Otsu", "Phansalkar", "Sauvola");
...
Dialog.addChoice("Algorithm", local_thresholds, local_thresholds[local_thresholds.length-2]);
